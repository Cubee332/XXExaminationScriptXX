--!nolint
-- ============================================
-- Examination v16.7.8 性能优化+魔法子弹逻辑优化
-- 此脚本使用AI生成
...
title.Text = "Examination v16.7.8"
...
local function applyLayout(layout)
    ...
    title.Text = "Examination v16.7.8 - " .. (layout == "mobile" and "手机" or "电脑")
...
title.Text = "Examination v16.7.8 - " .. (currentLayout == "mobile" and "手机" or "电脑")
...
(function()
    ...
    local function getClip()
        ...
        if n and n > 0 then
            ...
            if n > cur then clipMaxByTool[tool.Name] = n end
        end
        return n
    end
...
bindTap(closeBtn, function()
    ...
    print("[Exam] v16.7.8 已完全卸载")
end)

print("[Exam] v16.7.8 已加载（布局=" .. currentLayout .. "）")
